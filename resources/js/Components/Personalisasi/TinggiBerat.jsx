...
export default function TinggiBerat({ setData, data }) {
    return (
        <div className="flex flex-col items-center  pb-[5rem] ">
            <span className="text-xl opacity-80">Pertanyaan 3/4</span>
            <Title
                text={"Berapa tinggi dan berat badan Anda?"}
                className="text-center"
            />
            <input
                type="number"
                className="md:max-w-xs max-w-[250px] w-full bg-white rounded-xl p-[1rem] text-black mt-[2rem]"

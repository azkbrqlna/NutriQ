...
export default function Login() {
    ...
    return (
        <div className="h-screen flex flex-col  justify-center items-center gap-[2rem]">
            ...
            <div className="card max-w-xs w-full p-[1.5rem] rounded-xl fill-secondary shadow-lg">
                <form onSubmit={handeLogin} className="flex flex-col">
                    <div className="flex flex-col gap-[0.5rem]">
                        ...
                        <input
                            ...
                            className="fill-primary outline-none rounded-md focus:ring-2 focus:ring-fill-tertiary"
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        className="mt-[2rem] fill-quartenary text-white p-[0.5rem] rounded-md font-semibold hover:opacity-80"
                    >
                        Login
                    </button>
                </form>
